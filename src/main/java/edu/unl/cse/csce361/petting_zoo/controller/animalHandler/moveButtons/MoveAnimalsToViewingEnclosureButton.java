...
public class MoveAnimalsToViewingEnclosureButton implements Command {


    @Override
    public String toString() {
        return "Move animals to Viewing Enclosure";
    }
    ...
    public void execute() {
        ...
        outputStr.append("Moved all the animals to Viewing Enclosure 1!");
        UserInterfaceManager.getUI().showInformation(outputStr.toString());
        javax.persistence.Query query1 = HibernateUtil.getSession().createQuery("UPDATE AnimalEntity SET location_name = 'Viewing Enclosure 1'");
