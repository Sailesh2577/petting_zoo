...
public class MoveAnimalsToTheBarnButton implements Command {


    @Override
    public String toString() {
        return "Move animals to the Barn";
    }
    ...
    public void execute() {
        ...
        outputStr.append("Moved all the animals to The Barn!");
        UserInterfaceManager.getUI().showInformation(outputStr.toString());
        javax.persistence.Query query1 = HibernateUtil.getSession().createQuery("UPDATE AnimalEntity SET location_name = 'The Barn'");
